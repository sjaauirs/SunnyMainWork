-- Check and create the "Food" wallet type
DO $$
BEGIN
    IF EXISTS (
        SELECT 1 FROM wallet.wallet_type WHERE wallet_type_code = 'wat-35d4rt62d77y6119a6t730c9b6447457' -- Specify your wallet type here 
    ) THEN
        RAISE NOTICE 'Wallet type "Food" already exists.';
    ELSE
        ...
        VALUES (
            'wat-35d4rt62d77y6119a6t730c9b6447457', 'Food', NOW(), 'per-915325069cdb42c783dd4601e1d27704', 0,
            'Food', 'Food', false
        );
        RAISE NOTICE 'Wallet type "Food" created successfully.';
    END IF;
END $$;

-- Create "Food" Benefits Master Funding Wallet for Tenant
DO $$
DECLARE
    wallet_type_code_value varchar(50) := 'wat-35d4rt62d77y6119a6t730c9b6447457'; -- Specify your wallet type here 
    tenant_code_value varchar(50) := 'ten-ecada21e57154928a2bb959e8365b8b4';  -- Specify your tenant code here 
    wallet_name_value varchar(80) := 'FOOD'; -- Specify your wallet name here 
...
-- Create TENANT_MASTER_REDEMPTION:SUSPENSE_WALLET_FOOD Benefits Master Funding Wallet for Tenant
DO $$
DECLARE
    wallet_type_code_value varchar(50) := 'wat-bc8f4f7c028d479f900f0af794e385c8'; -- Specify your wallet type here 
    tenant_code_value varchar(50) := 'ten-ecada21e57154928a2bb959e8365b8b4';  -- Specify your tenant code here 
    wallet_name_value varchar(80) := 'TENANT_MASTER_REDEMPTION:SUSPENSE_WALLET_FOOD'; -- Specify your wallet name here 
