-- Check and create the "Vision" wallet type
DO $$
BEGIN
    IF EXISTS (
        SELECT 1 FROM wallet.wallet_type WHERE wallet_type_code = 'wat-cb7234r5d778599fb2960a30f82f67r9' -- Specify your wallet type here 
    ) THEN
        RAISE NOTICE 'Wallet type "Vision" already exists.';
    ELSE
        ...
        VALUES (
            'wat-cb7234r5d778599fb2960a30f82f67r9', 'Vision', NOW(), 'per-915325069cdb42c783dd4601e1d27704', 0,
            'Vision', 'Vision', false
        );
        RAISE NOTICE 'Wallet type "Vision" created successfully.';
    END IF;
END $$;

-- Create "Vision" Benefits Master Funding Wallet for Tenant
DO $$
DECLARE
    wallet_type_code_value varchar(50) := 'wat-cb7234r5d778599fb2960a30f82f67r9'; -- Specify your wallet type here 
    tenant_code_value varchar(50) := 'ten-ecada21e57154928a2bb959e8365b8b4';  -- Specify your tenant code here 
    wallet_name_value varchar(80) := 'VISION'; -- Specify your wallet name here 
...
-- Create TENANT_MASTER_REDEMPTION:SUSPENSE_WALLET_VISION Benefits Master Funding Wallet for Tenant
DO $$
DECLARE
    wallet_type_code_value varchar(50) := 'wat-bc8f4f7c028d479f900f0af794e385c8'; -- Specify your wallet type here 
    tenant_code_value varchar(50) := 'ten-ecada21e57154928a2bb959e8365b8b4';  -- Specify your tenant code here 
    wallet_name_value varchar(80) := 'TENANT_MASTER_REDEMPTION:SUSPENSE_WALLET_VISION'; -- Specify your wallet name here 
