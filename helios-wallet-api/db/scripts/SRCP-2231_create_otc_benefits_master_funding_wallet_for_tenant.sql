...
BEGIN
    ...
    ELSE
        ...
        VALUES (
            'wat-4b364fg722f04034cv732b355d84f479', 'Over the Counter', NOW(), 'per-915325069cdb42c783dd4601e1d27704', 0,
            'OTC', 'OTC', false
        );
...
-- Create OTC Benefits Master Funding Wallet for Tenant
DO $$
DECLARE
    ...
    wallet_name_value varchar(80) := 'OTC_BENEFITS_MASTER'; -- Specify your wallet name here 
...
-- Create TENANT_MASTER_REDEMPTION:SUSPENSE_WALLET_OTC Benefits Master Funding Wallet for Tenant
DO $$
DECLARE
    wallet_type_code_value varchar(50) := 'wat-bc8f4f7c028d479f900f0af794e385c8'; -- Specify your wallet type here 
    tenant_code_value varchar(50) := 'ten-ecada21e57154928a2bb959e8365b8b4';  -- Specify your tenant code here 
    wallet_name_value varchar(80) := 'TENANT_MASTER_REDEMPTION:SUSPENSE_WALLET_OTC'; -- Specify your wallet name here 
