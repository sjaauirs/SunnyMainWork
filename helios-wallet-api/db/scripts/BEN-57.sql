--===============================================================================
-- Script  : Increase wallet_type_label column length, Update wallet_type_name and wallet_type_label based on short_label
-- Jira    : BEN-57
--===============================================================================
BEGIN;

ALTER TABLE wallet.wallet_type
ALTER COLUMN wallet_type_label TYPE varchar(255);
