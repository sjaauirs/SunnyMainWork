...
-- 📌 Purpose   : Add or update `primaryMenu`, `secondaryMenu`, and 
--                `showSelectedPrimaryMenuItem` inside tenant_option_json.benefitsOptions
...
DECLARE
    ...
    v_json_input    JSONB := '{
        "primaryMenu": ["myCard","shop","myRewards"],
...
BEGIN
    ...
    -- ✅ Step 3: Check existence of keys
    ...
    RAISE NOTICE '✅ Successfully applied menu updates and flag for tenant_code: %', v_tenant_code;
