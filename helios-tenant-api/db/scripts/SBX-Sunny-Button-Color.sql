-- 🚀 Script    : Update button colors under ux.commonColors and ux.button for SUNNY tenant
-- 📌 Purpose   : Updates primary button and text colors to match SUNNY brand
-- 🧑 Author    : Riaz Ahmed
-- 📅 Date      : 2025-11-12
-- 🧾 Jira      : 
    ...
    LOOP
        ...
        SET tenant_attr = tenant_attr::jsonb
            ...
            |> jsonb_set(
                ...
                || jsonb_build_object(
                    'primaryBgColor', '#FAB306',
                    'primaryTextColor', '#151E23'
                ),
                true
            ),
            update_user = v_user,
