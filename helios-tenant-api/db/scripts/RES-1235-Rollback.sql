-- ============================================================================
-- 🚀 Script    : rollback showSelectedPrimaryMenuItem for navitus
-- 📌 Purpose   : rollback showSelectedPrimaryMenuItem  to tenant_option_json JSONB
-- 🧑 Author    : Kawalpreet Kaur
-- 📅 Date      : 2025-11-18
-- 🧾 Jira      : RES-1235
-- ⚠️ Inputs    : tenant_codes (TEXT ARRAY)
-- 📤 Output    : rollback tenant_option_json JSONB 
-- 🔗 Script URL: <NA>
