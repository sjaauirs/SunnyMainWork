-- ============================================================================
-- 🚀 Script    : Update onbaarding flow to remove agreement screen
-- 📌 Purpose   : Updates onbaarding flow  under
--                a specific tenant by mapping tenant name to flow steps for healthy_living_rewards cohort.
...
-- 🚀 Script    : Update onbaarding flow to remove agreement screen
-- 📌 Purpose   : Updates onbaarding flow  under
--                a specific tenant by mapping tenant name to flow steps for hap_flex_rewards cohort
-- 🧑 Author    : KAWALPREET KAUR
-- 📅 Date      : 2025-10-06
-- 🧾 Jira      : RES-569
-- ⚠️ Inputs    : v_tenant_code (TEXT) 
...
-- 🚀 Script    : Update onbaarding flow to remove agreement screen
-- 📌 Purpose   : Updates onbaarding flow  under
--                a specific tenant by mapping tenant name to flow steps for henry_ford_health_flex_rewards cohort
-- 🧑 Author    : KAWALPREET KAUR
-- 📅 Date      : 2025-10-06
-- 🧾 Jira      : RES-569
-- ⚠️ Inputs    : v_tenant_code (TEXT) 
