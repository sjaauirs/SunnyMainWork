...
-- 🎫 JIRA Ticket  : BEN-855
-- ⚙️ Inputs       : Replace <HAP-TENANT-CODE> with the actual tenant code
...
DECLARE
    ...
    v_member_portal_url TEXT := 'https://portal.hap.org/membernew/memberportal/profile/updateProfile';
BEGIN
    ...
    IF NOT FOUND THEN
        RAISE WARNING '⚠️No tenant found or tenant_attr is empty for tenant_code: %', v_tenant_code;
        RETURN;
    END IF;
