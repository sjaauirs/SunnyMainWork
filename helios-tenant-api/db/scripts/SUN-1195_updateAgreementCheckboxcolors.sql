...
BEGIN
    ...
    END IF;
        ...
        SET tenant_attr = jsonb_set(
            ...
            '{ux,agreementColors,agreeCheckboxColor}',
            '"#FE7200"'::jsonb,
            true
        )
        WHERE tenant_code = v_tenant_code
        ...
        RAISE NOTICE 'tenant_attr.ux.agreementColors agreeCheckboxColor updated successfully for tenant %', v_tenant_code;
