-- ============================================================================
-- 🚀 Script    : Rollback Language Specific Redirect Links in Tenant Attribute
-- 📌 Purpose   : Rollback of 'languageSpecificContent' JSON under tenant_attr
...
-- 📤 Output    : Rollback(update to previous value) tenant_attr JSONB column with new redirect URLs
-- 🔗 Script URL: NA
-- 📝 Notes     : 
