...
-- 🔗 Script URL: https://github.com/SunnyRewards/helios-tenant-api/blob/develop/db/scripts/RES-569-Rollback-NAVITUS-tenant-Onboarding-flow-steps.sql
-- ============================================================================

DO $$
DECLARE
    -- ========= INPUT PARAMETERS =========
    v_tenant_code TEXT := '<NAVITUS-TENANT-CODE>';     -- <<<<<< INPUT NAVITUS TENANT CODE
	...
	-- INPUT Array of FLOW steps for NAVITUS-TENANT (ORDER MATTERS!)
