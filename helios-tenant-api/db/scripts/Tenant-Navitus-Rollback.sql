-- ===============================================================================  
-- Script   : Rollback - tenant_attr URL Normalization (Environment-Specific URLs)  
-- Author   : Vinod Ullaganti  
-- Date     : 2025-07-22  
-- Jira     : SOCT-1375  
-- Purpose  : 🔁 Rollback tenant_attr to previous known good state  
--             (reverts any '.uat.', '.qa.', or '.integ.' URL changes in JSONB)  
-- ===============================================================================  
-- ⚠️ CRITICAL CAUTION:  
--     🚨 This script **overwrites** tenant_attr JSON with a prior version  
--     🔍 Make sure this JSON is a verified *pre-change* snapshot  
--     🧪 Confirm the rollback applies to the right environment  
--     ❗ Ensure tenant_code is correct to avoid accidental overwrite  
-- ===============================================================================  
--     ❗❗ This script is intended for PROD or QA rollback purposes ❗❗  
--     ❗❗ DO NOT RUN without full review and approval ❗❗  
-- ===============================================================================
...
--    "ownerMaximum": 125,
--    "walletMaximum": 125,
--    "individualWallet": false,
--    "contributorMaximum": 250,
--    "splitRewardOverflow": true
--  },
--  "jitfTimeOffset": 40,
--  "isHybridRewards": true,
...
--  "justInTimeFunding": false,
--  "benefitsCardArtUrl": "https://app-static.integ.sunnyrewards.com/public/images/Navitus+Card+2.png",
--  "walletSplitEnabled": false,
--  "adventureEarnMaximum": 100,
--  "spinwheelTaskEnabled": false,
--  "monetarySplashScreens": [
...
--  "costcoMembershipSupport": false,
--  "nonMonetaryFTUEFileName": "/assets/images/bf_nonmononly_ftue_new.svg",
--  "spendOnGiftCardDisabled": false,
--  "disableMembershipDollars": true,
--  "nonMonetarySplashScreens": [
--    "/assets/images/ftue-swiper2.svg"
--  ],
--  "nonmonetaryPrizesEnabled": true,
...
--  "pickAPurseOnboardingEnabled": false,
--  "maxAllowedPickAPurseSelection": 1,
--  "pickAPurseFundTransferEnabled": false
--}