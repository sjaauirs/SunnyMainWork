...
-- 🔗 Script URL: https://github.com/SunnyRewards/helios-tenant-api/blob/develop/db/scripts/RES-569-Rollback-SUNNY-tenant-Onboarding-flow-steps.sql
-- ============================================================================

DO $$
DECLARE
    -- ========= INPUT PARAMETERS =========
    v_tenant_code TEXT := '<SUNNY-TENANT-CODE>';     -- <<<<<< INPUT SUNNY TENANT CODE
    ...
    v_version_nbr INT  := 1;                      -- Input Version Number 
	  ...
	  -- INPUT Array of steps For SUNNY-TENANT (ORDER MATTERS!)
