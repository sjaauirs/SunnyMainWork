...
-- 📌 Purpose   : For WATCO-TENANT-CODE need to update tenant_attr with additional colour codes
-- 🧑 Author    : Siva Krishna
-- 📅 Date      : 2025-09-22
-- 🧾 Jira      : RES-550
...
DO $$
DECLARE
    v_tenant_code TEXT := '<WATCO-TENANT-CODE>';  -- 🔹 Replace with input tenant_code
