-- ============================================================================
-- 🚀 Script    : Update tenant_option_json → benefitsOptions.hamburgerMenu
-- 📌 Purpose   : Add or update `hamburgerMenu` array inside tenant_option_json.benefitsOptions
...
BEGIN
    ...
    -- ✅ Step 4: Update JSON — modify or insert the hamburgerMenu key
    ...
    RAISE NOTICE '✅ Successfully applied hamburgerMenu update for tenant_code: %', v_tenant_code;
