-- ============================================================================
-- 🚀 Script    : Add marketing banner keys for Navitus
-- 📌 Purpose   : Add marketing banner keys for Navitus
-- 👨‍💻 Author    : Charan
-- 📅 Date      : 2025-12-31
-- 🧾 Jira      : SUN-1284
            ...
            jsonb_set(
                ...
                jsonb_set(
                    ...
                    jsonb_set(
                        ...
                        || jsonb_build_object(
                            'marketingBannerBackgroundColor', '#E3E5E8',
                            'marketingBannerTextColor', '#0B0C0E'
                        ),
                        true
                    ),
                ...
                '{marketingBannerText}',
                jsonb_build_object(
                    'en-US', 'Use your card at Costco, CVS, Kroger, Walgreens, and many other stores. Some Walmart and Target locations may not be able to process card payments right now.',
