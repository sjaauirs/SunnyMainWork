-- ============================================================================
-- 🚀 Script    : Update button colors under ux.commonColors and ux.themeColors for KP tenant
-- 📌 Purpose   : Updates errorBorderColor, dollar and RewardDialTextColor to match KP brand
-- 🧑 Author    : Riaz Ahmed
-- 📅 Date      : 2025-11-21
-- 🧾 Jira      : SUN-1062
...
BEGIN
    ...
    LOOP
        ...
        RAISE NOTICE '✅ Updated ux.commonColors.errorBorderColor, dollar and ux.themeColors.RewardDialTextColor for tenant %', v_tenant_code;
    END LOOP;
END $$;