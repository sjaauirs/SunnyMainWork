-- ============================================================================
-- 🚀 Script    : Add Terms and Conditions Visibility Flag to Tenant Attribute
-- 📌 Purpose   : Adds a new top-level JSONB key `isTermsAndConditionVisibleForOrderCard` 
...
BEGIN
  ...
  SET tenant_attr = tenant_attr || jsonb_build_object('isTermsAndConditionVisibleForOrderCard', false)
