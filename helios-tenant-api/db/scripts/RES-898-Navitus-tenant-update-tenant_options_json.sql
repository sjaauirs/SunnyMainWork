...
$$
DECLARE
    v_tenant_code   TEXT := '<NAVITUS-TENANT-CODE>';  -- Replace with target tenant code
    v_json_input    JSONB := '{
        "primaryMenu": ["myCard","myRewards"],
        "secondaryMenu": ["privacyPolicy","signOut"],
...
BEGIN
    ...
    RAISE NOTICE '✅ Successfully applied menu and flag updates for tenant_code: %', v_tenant_code;
