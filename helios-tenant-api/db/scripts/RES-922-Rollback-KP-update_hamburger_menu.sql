-- ============================================================================
-- 🚀 Script    : Rollback to previous state tenant_option_json → benefitsOptions.hamburgerMenu
...
BEGIN
    ...
    IF v_hamburger_exist THEN
        RAISE NOTICE '🔄 hamburgerMenu exists — Rollbacked with input values';
    ELSE
    ...
    RAISE NOTICE '✅ Successfully applied hamburgerMenu Rollback(to the default keys) for tenant_code: %', v_tenant_code;
