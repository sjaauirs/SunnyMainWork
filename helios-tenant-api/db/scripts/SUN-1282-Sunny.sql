-- ============================================================================
-- 🚀 Script    : Add marketing banner keys for Sunny
-- 📌 Purpose   : Add marketing banner keys for Sunny
-- 👨‍💻 Author    : Charan
-- 📅 Date      : 2025-12-31
-- 🧾 Jira      : SUN-1282
            ...
            jsonb_set(
                ...
                jsonb_set(
                    ...
                    jsonb_set(
                        ...
                        || jsonb_build_object(
                            'marketingBannerBackgroundColor', '#E9EBEE',
                            'marketingBannerTextColor', '#0D1C3D'
                        ),
                        true
                    ),
