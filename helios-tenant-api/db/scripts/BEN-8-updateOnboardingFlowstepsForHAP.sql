...
-- 🔗 Script URL: https://github.com/SunnyRewards/helios-tenant-api/blob/develop/db/scripts/BEN-8-updateOnboardingFlowstepsForHAP.sql
-- 📝 Notes     : 
...
DECLARE
    ...
    v_cohort_code TEXT := NULL;                   -- <<<<<< CHANGE COHORT CODE (nullable allowed)
    v_flow_name   TEXT := 'onboarding_flow';
    v_version_nbr INT  := 2;                      -- Input Version Number 
