...
DECLARE
    ...
    v_taskTileColors JSONB := '{
        "borderColor": "#000A0D",
        "actionsBgColor": "#F7F4F0",
        "completedTileBgColor": "#66615C",
        "inProgressBgColor": "#181D27",
        "activeTabBgColor": "#181D27",
        "inProgressTextFgColor": "#45474D",
        "completeTextFgColor": "#45474D",
        "ctaButtonBgColor": "transparent"
    }';
	  v_walletColors JSONB := '{
        "strokeEarnedColor": "#FF7200",
		"strokeSegmentColor": "#C9CACC"		  
    }';
