...
if [ "$push_nuget" = "true" ] ; then
	nuget_path="$4"
	dotnet nuget push ${nuget_path}/nuget/*.nupkg -s https://heliosnugetrepo-375611915274.d.codeartifact.us-east-2.amazonaws.com/nuget/helios-common-lib/v3/index.json --skip-duplicate
fi
