 ...
 -- Create etl_outbound schema
 CREATE SCHEMA IF NOT EXISTS etl_outbound;
 -- Create etl_outbound.member_import_file table
 CREATE TABLE IF NOT EXISTS etl_outbound.member_import_file
(
...
-- Create etl_outbound.member_import_file_data table
CREATE TABLE IF NOT EXISTS etl_outbound.member_import_file_data
(
...
INSERT INTO etl_outbound.member_import_file (
    file_name,
    create_ts,
    update_ts,
    create_user,
...
INSERT INTO etl_outbound.member_import_file_data (
...
GRANT USAGE ON SCHEMA etl_outbound TO appuser;

-- Grant access to all existing tables in the schema
GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA etl_outbound TO appuser;

-- Grant access to future tables created in the schema
