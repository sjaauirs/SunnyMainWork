-- ============================================================================
-- 🚀 Script    : Remove permission tag to tenant reward config json to task
-- 📌 Purpose   : Remove permission:exercise tag to tenant reward config json for strengthen your body task
-- 🧑 Author    : Neel
-- 📅 Date      : 2025-12-12
-- 🧾 Jira      : SUN-923
-- ⚠️ Inputs    : <KP-TENANT-CODE>
-- 📤 Output    : Removes the JSONB structure with the new key-value pair
-- 🔗 Script URL: <NA>
    ...
    LOOP         
      -- Add new key to tenant_attr JSONB
       UPDATE task.task_reward
        SET task_reward_config_json = null
