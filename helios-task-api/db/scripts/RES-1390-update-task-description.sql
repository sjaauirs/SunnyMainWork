--===============================================================================
-- Script Name : Update Task Descriptions by Tenant
  ...
  v_mapping JSONB := '[
        {
            ...
            "taskDescription": [
				...
				},
				{
					"type": "paragraph",
					"data": {
						"text": "\nMake your appointment today. You''ll get your reward after we receive a claim from your doctor. This can take about 30-60 days after your appointment. Need help finding a doctor? Use the \"Find a Doctor\" tool."
					}
				}
			]
        },
            ...
            "taskDescription": [
				{
					"type": "paragraph",
					"data": {
						"text": "Flu season starts in October. Get your annual flu shot to avoid getting really sick or going to the hospital. It also helps protect your family and friends.\n\nGet your shot to stay healthy and earn a reward! Once you get your flu shot, you can report it by clicking Get started. Or you can wait until we receive a claim from your doctor. This can take about 30-60 days after your appointment."
					}
				}
			]
        },
            ...
            "taskDescription": [
				{
					"type": "paragraph",
					"data": {
						"text": "Managing your diabetes means having your A1C checked regularly to avoid complications.\n\nGet one A1C test between January 1 and June 30 to earn a reward. Get another between July 1 and December 31 to earn a second reward.\n\nCall your doctor today to schedule your next A1C test. Once you complete your test, you can report it by clicking Get started. Or you can wait until we receive a claim from your doctor. This can take about 30-60 days after your appointment."
					}
				}
			]
        },
            ...
            "taskDescription": [
				{
					"type": "paragraph",
					"data": {
						"text": "Diabetes can affect your eyes, so regular eye exams are important to avoid vision loss.\n\nCall your eye doctor to schedule a diabetic eye exam. Once you complete your exam, you can report it by clicking Get started. Or you can wait until we receive a claim from your doctor. This can take about 30-60 days after your appointment."
					}
				}
			]
        },
        {
           "taskExternalCode": "comp_a_reco_colo_scre",
            "taskDescription": [
				...
				},
				{
					"data": {
						"items": [
							...
							"Sigmoidoscopy: checks the lower part of your colon and rectum (usually every 5 years)"
						],
						"style": "unordered"
					},
					"type": "list"
				...
				{
					"data": {
						"text": "\nTalk to your doctor to see if you need a screening and to schedule it. You''ll earn a reward once you complete one. Once you complete your screening, you can report it by clicking Get started. Or you can wait until we receive a claim from your doctor. This can take about 30-60 days after your appointment."
					},
					"type": "paragraph"
				}
			]
            ...
            "taskDescription": [
				{
					"type": "paragraph",
					"data": {
						"text": "Mammograms are the best way to find breast cancer early. Finding it early means a better chance of beating it. Talk with your doctor to see if you need a screening. If you are due for a screening, get it done and earn a reward. Once you complete your screening, you can report it by clicking Get started. Or you can wait until we receive a claim from your doctor. This can take about 30-60 days after your appointment."
					}
				}
			]
        }
