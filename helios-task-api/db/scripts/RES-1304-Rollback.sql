-- ============================================================================
-- 🚀 Script    : Revert Task description for Get moving 2026
-- 📌 Purpose   : Revert task_description in task.task_detail table for matching 
...
-- 📤 Output    : Reverts task_description column for matching records.
-- 🔗 Script URL: NA
-- 📝 Notes     : 
