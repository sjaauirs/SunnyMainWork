-- =============================================================================
-- 🚀 Script    : Update ES Label in task_completion_criteria_json
-- 📌 Purpose   : Update the 'es' label under healthCriteria.unitLabel in task_completion_criteria_json
...
BEGIN
    ...
    RAISE NOTICE '✅ Updated ES label to "%" for task_external_code: %, tenant_code: %',
