-- ============================================================================
-- 🚀 Script    : Rollback Spanish Task Headers for Multiple Tenants
-- 📌 Purpose   : 
...
--        2. Updates(Rollback to previous value) task_header in task.task_detail for language='es'
...
-- 🔗 Script URL: NA
-- 📝 Notes     :
--        - Will only Rollback Spanish language entries (language_code = 'es')
        ...
        "array_task_external_codes":[
            {
                ...
                "task_header": "Tómese un descanso del alcohol"
            },
            {
