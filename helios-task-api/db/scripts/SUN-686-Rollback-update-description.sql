-- ============================================================================
-- 🚀 Script       : Rollback  description for en-US Components (adventure-driven)
            ...
            LOOP
                BEGIN
                    ...
                    IF v_adventure_name = 'healthy-eating' THEN
						v_adventure_description:= 'Fuel up with balanced meals to power your day.';

					ELSIF v_adventure_name = 'self-care' THEN
						v_adventure_description:= 'Relax, recharge, and boost your physical and emotional well-being.';

					ELSIF v_adventure_name = 'exercise' THEN
						v_adventure_description:= 'Get moving with activities that keep you feeling your best.';
