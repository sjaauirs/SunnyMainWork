-- =================================================================================================================================
-- 🚨 Rollback Script : RES-51 "Your Voice Matters" QA Inserts Only
-- 📌 Purpose         : Rollback inserted data created by RES-51 for QA tenants
...
DO $$
DECLARE
    v_tenant_code TEXT := '<KP_TENANT_CODE>'; -- QA KP tenant only
