...
DO $$
DECLARE  
    v_cohort_name TEXT := 'adult18up';
	v_task_name TEXT := 'Play Healthy Trivia';
	v_task_detail_name TEXT := 'Play Healthy Trivia';
...
BEGIN
    BEGIN
        ...
        SELECT v_cohort_code, v_cohort_name, 'This is a cohort with person age 18+', NULL, '{}'::jsonb,
