...
public class TaskTriggerEventProcessorTests
{
    private readonly Mock<ILogger<TaskTriggerEventProcessor>> _mockLogger;
    ...
    private readonly Mock<IAutoEnrollConsumerTaskService> _mockAutoEnrollService;

    private readonly TaskTriggerEventProcessor _processor;
    private readonly TaskTriggerEventProcessor _eventProcessor;
    private readonly IEventProcessorHelper _eventProcessorHelper;

    public TaskTriggerEventProcessorTests()
    {
        _mockLogger = new Mock<ILogger<TaskTriggerEventProcessor>>();
        ...
        _mockAutoEnrollService = new Mock<IAutoEnrollConsumerTaskService>();
        ...
        _processor = new TaskTriggerEventProcessor(
            _mockLogger.Object,
            _mockAutoEnrollService.Object,
    ...
    {
         new Argument { ArgName = "autoEnrollConsumerTaskService", ArgType = "object" },
          new Argument { ArgName = "autoEnrollConsumerTaskRequestDto", ArgType = "object" }
    },
            Result = new Result
            {
                ResultMap = "Map1",
