-- This is a sample script to create a Tenant Admin user.
-- Steps to get TenantAdmin code
...
DECLARE
    ...
    v_role_code VARCHAR := 'rol-44e107f38dda4423bf653525fb9c1938';      -- Example role_code
    v_customer_code VARCHAR;                -- To hold the customer_code
    v_sponsor_code VARCHAR;                 -- To hold the sponsor_code
    v_tenant_code VARCHAR;                 -- To hold the tenant_code
...
BEGIN
    -- Fetch person_id, tenant_code from huser.consumer
    SELECT person_id, tenant_code INTO v_person_id, v_tenant_code
    FROM huser.consumer
