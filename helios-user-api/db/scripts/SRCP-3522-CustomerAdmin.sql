-- This is a sample script to create a Customer Admin user.
-- Steps to get CustomerAdmin code
...
DECLARE
    ...
    v_role_code VARCHAR := 'rol-938b67672b3f4dcaba54435e95dda6c5';      -- Replace with the actual role_code
...
BEGIN
    ...
    -- Fetch customer_code dynamically
    ...
    WHERE customer_id = (SELECT customer_id FROM SponsorCustomer) AND delete_nbr = 0;
